...
public class ArcpocalypseItems {
	...
	public static final Item TRUE_ANCESTOR_MARBLE = createItem("true_ancestor_marble", new NecoItem(new QuiltItemSettings().maxCount(1), NekoArcComponent.TypeNeco.ARC));
