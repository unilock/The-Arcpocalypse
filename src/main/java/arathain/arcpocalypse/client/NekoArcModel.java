...
public class NekoArcModel extends BipedEntityModel<PlayerEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		hat.addChild("ear_r1", ModelPartBuilder.create().uv(43, 12).cuboid(3.0F, -1.0F, -0.5F, 3.0F, 3.0F, 1.0F, new Dilation(0.3F)), ModelTransform.of(0.0F, -7.0F, 0.0F, 0.0F, 0.0F, -0.2182F));
		hat.addChild("ear_r2", ModelPartBuilder.create().uv(45, 22).cuboid(-6.0F, -1.0F, -0.5F, 3.0F, 3.0F, 1.0F, new Dilation(0.3F)), ModelTransform.of(0.0F, -7.0F, 0.0F, 0.0F, 0.0F, 0.2182F));
		...
		head.addChild("eyes", ModelPartBuilder.create().uv(45, 0).cuboid(-3.8F, -4.0F, -3.5F, 3.0F, 2.0F, 1.0F, new Dilation(0.3F))
		...
		head.addChild("hair_r1", ModelPartBuilder.create().uv(47, 44).cuboid(-2.0F, -1.0F, -3.0F, 2.0F, 8.0F, 6.0F, new Dilation(0.1F)), ModelTransform.of(4.0F, -7.0F, 0.0F, 0.0F, 0.0F, -0.3054F));
		head.addChild("hair_r2", ModelPartBuilder.create().uv(47, 20).cuboid(0.0F, -1.0F, -3.0F, 2.0F, 8.0F, 6.0F, new Dilation(0.1F)), ModelTransform.of(-4.0F, -7.0F, 0.0F, 0.0F, 0.0F, 0.3054F));
		head.addChild("morehair_r1", ModelPartBuilder.create().uv(25, 23).cuboid(-4.0F, 0.0F, -3.0F, 8.0F, 8.0F, 3.0F, new Dilation(0.1F)), ModelTransform.of(0.0F, -7.0F, 3.0F, 0.3491F, 0.0F, 0.0F));
		head.addChild("HeadLayer_r1", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -5.0F, -3.0F, 8.0F, 7.0F, 6.0F, new Dilation(0.3F)), ModelTransform.of(0.0F, -2.0F, 0.0F, -0.0436F, 0.0F, 0.0F));
		...
		body.addChild("skirfront_r1", ModelPartBuilder.create().uv(0, 59).cuboid(-3.0F, 0.0F, -1.5F, 6.0F, 3.0F, 2.0F, new Dilation(-0.001F)), ModelTransform.of(0.0F, -1.0F, 0.0F, -0.2618F, 0.0F, 0.0F));
		body.addChild("skirtleft_r1", ModelPartBuilder.create().uv(38, 0).cuboid(-0.975F, -0.1F, -1.5F, 2.0F, 3.0F, 3.0F, new Dilation(-0.001F)), ModelTransform.of(2.0F, -1.0F, 0.0F, 0.0F, 0.0F, -0.2618F));
		body.addChild("skirtright_r1", ModelPartBuilder.create().uv(13, 38).cuboid(-1.025F, -0.1F, -1.5F, 2.0F, 3.0F, 3.0F, new Dilation(-0.001F)), ModelTransform.of(-2.0F, -1.0F, 0.0F, 0.0F, 0.0F, 0.2618F));
		body.addChild("skirtback_r1", ModelPartBuilder.create().uv(16, 59).cuboid(-3.0F, 0.0F, -0.5F, 6.0F, 3.0F, 2.0F, new Dilation(-0.0001F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.2618F, 0.0F, 0.0F));

		modelPartData.addChild("right_arm", ModelPartBuilder.create().uv(45, 44).cuboid(-1.0F, -1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new Dilation(0.0F))
		...
		modelPartData.addChild("right_leg", ModelPartBuilder.create().uv(39, 38).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new Dilation(0.0F))
		...
		modelPartData.addChild("left_leg", ModelPartBuilder.create().uv(31, 38).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new Dilation(0.0F))
		...
		modelPartData.addChild("left_arm", ModelPartBuilder.create().uv(8, 44).cuboid(-1.0F, -1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new Dilation(0.0F))
		...
		tail.addChild("cube_r1", ModelPartBuilder.create().uv(32, 56).cuboid(-0.5F, -1.0F, -0.7F, 1.0F, 1.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 4.2F, 0.0F, -0.7418F, 0.0F, 0.0F));
	...
	public static TexturedModelData getTexturedMaidModelData() {
		...
		hat.addChild("leftear_r1", ModelPartBuilder.create().uv(28, 37).cuboid(3.0F, -1.0F, -0.5F, 3.0F, 3.0F, 1.0F, new Dilation(0.3F)), ModelTransform.of(0.0F, -7.0F, 0.0F, 0.0F, 0.0F, -0.2182F));
		hat.addChild("ear_r1", ModelPartBuilder.create().uv(28, 33).cuboid(-6.0F, -1.0F, -0.5F, 3.0F, 3.0F, 1.0F, new Dilation(0.3F)), ModelTransform.of(0.0F, -7.0F, 0.0F, 0.0F, 0.0F, 0.2182F));
		...
		head.addChild("hair_r1", ModelPartBuilder.create().uv(44, 26).cuboid(-2.0F, -1.0F, -3.0F, 2.0F, 8.0F, 6.0F, new Dilation(0.1F)), ModelTransform.of(4.0F, -7.0F, 0.0F, 0.0F, 0.0F, -0.3054F));
		head.addChild("otherhair_r1", ModelPartBuilder.create().uv(46, 12).cuboid(0.0F, -1.0F, -3.0F, 2.0F, 8.0F, 6.0F, new Dilation(0.1F)), ModelTransform.of(-4.0F, -7.0F, 0.0F, 0.0F, 0.0F, 0.3054F));
		head.addChild("bowtie_r1", ModelPartBuilder.create().uv(8, 22).cuboid(-3.0F, 1.0F, -0.8F, 6.0F, 4.0F, 1.0F, new Dilation(0.25F))
				.uv(22, 23).cuboid(-4.0F, 0.0F, -3.0F, 8.0F, 7.0F, 3.0F, new Dilation(0.1F)), ModelTransform.of(0.0F, -7.0F, 3.0F, 0.3491F, 0.0F, 0.0F));
		head.addChild("HeadLayer_r1", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -5.0F, -3.0F, 8.0F, 3.0F, 6.0F, new Dilation(0.3F)), ModelTransform.of(0.0F, -2.0F, 0.0F, -0.0436F, 0.0F, 0.0F));
		head.addChild("eyes", ModelPartBuilder.create().uv(48, 3).cuboid(-3.8F, -4.0F, -3.5F, 3.0F, 2.0F, 1.0F, new Dilation(0.3F))
		...
		body.addChild("skirtoverlayfront_r1", ModelPartBuilder.create().uv(0, 37).cuboid(-3.0F, 0.0F, -1.5F, 6.0F, 5.0F, 2.0F, new Dilation(0.05F))
				.uv(0, 50).cuboid(-3.0F, 0.0F, -1.5F, 6.0F, 6.0F, 2.0F, new Dilation(-0.001F)), ModelTransform.of(0.0F, -1.0F, 0.0F, -0.1309F, 0.0F, 0.0F));
		body.addChild("skirtoverlayleft_r1", ModelPartBuilder.create().uv(34, 41).cuboid(-0.975F, -0.1F, -1.5F, 2.0F, 5.0F, 3.0F, new Dilation(0.01F))
				.uv(0, 28).cuboid(-0.975F, -0.1F, -1.5F, 2.0F, 6.0F, 3.0F, new Dilation(-0.001F)), ModelTransform.of(2.0F, -1.0F, 0.0F, 0.0F, 0.0F, -0.1309F));
		body.addChild("skirtoverlayright_r1", ModelPartBuilder.create().uv(44, 41).cuboid(-1.025F, -0.1F, -1.5F, 2.0F, 5.0F, 3.0F, new Dilation(0.01F))
				.uv(10, 28).cuboid(-1.025F, -0.1F, -1.5F, 2.0F, 6.0F, 3.0F, new Dilation(-0.001F)), ModelTransform.of(-2.0F, -1.0F, 0.0F, 0.0F, 0.0F, 0.1309F));
		body.addChild("skirtback_r1", ModelPartBuilder.create().uv(16, 51).cuboid(-3.0F, 0.0F, -0.5F, 6.0F, 6.0F, 2.0F, new Dilation(-0.0001F)), ModelTransform.of(0.0F, -1.0F, 0.0F, 0.1309F, 0.0F, 0.0F));

		modelPartData.addChild("right_arm", ModelPartBuilder.create().uv(0, 22).cuboid(-1.0F, -1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new Dilation(0.0F))
		...
		modelPartData.addChild("right_leg", ModelPartBuilder.create().uv(36, 33).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new Dilation(0.0F))
				.uv(29, 6).cuboid(-1.0F, 4.0F, -2.0F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-1.9F, 18.0F, 0.0F));
		modelPartData.addChild("left_leg", ModelPartBuilder.create().uv(20, 33).cuboid(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new Dilation(0.0F))
				.uv(29, 9).cuboid(-1.0F, 4.0F, -2.0F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(1.9F, 18.0F, 0.0F));
		modelPartData.addChild("left_arm", ModelPartBuilder.create().uv(37, 6).cuboid(-1.0F, -1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new Dilation(0.0F))
				.uv(44, 10).cuboid(-1.0F, -1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new Dilation(0.2F))
				.uv(22, 0).cuboid(-1.5F, 2.8F, -1.5F, 3.0F, 3.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(3.0F, 13.0F, 0.0F, 0.0F, 0.0F, -0.5236F));

		ModelPartData tail = modelPartData.addChild("tail", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 17.0F, 1.0F));

		tail.addChild("tail_r1", ModelPartBuilder.create().uv(28, 5).cuboid(-0.5F, -1.0F, -0.7F, 1.0F, 1.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 4.1F, 0, -0.7418F, 0.0F, 0.0F));
